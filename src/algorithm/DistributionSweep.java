 ...
 */
    ...
    private void recursiveDistributionSweep(String xSortedFilename, int beginOffset, int endOffset,
        ...
        if (getMemorySize(beginOffset, endOffset) < M) {
            ...
            Triple res = extractXSortedArray(xSortedFilename, beginOffset, endOffset);
            ArrayList<Segment> xSortedSegments = (ArrayList<Segment>) res.a;
            int beginIndex = (int) res.b;
            int endIndex = (int) res.c;

            ArrayList<Segment> ySortedSegments = extractYSortedArray(ySortedFilename);
            localRecursiveDistributionSweep(xSortedSegments, beginIndex, endIndex, ySortedSegments, verticalSegmentsNumber);
    ...
    private Triple extractXSortedArray(String xSortedFilename, int beginOffset, int endOffset) throws FileNotFoundException {
        ArrayList<Segment> xSortedArray = SegmentFileToArray(xSortedFilename, beginOffset, endOffset);
        return new Triple(xSortedArray, 0, xSortedArray.size() - 1);
    }
     ...
     *                               Indice de xSortedSegments hasta el cual se debe leer.
     *                               <p>
